...
function fileUploadCallback(files) {
    ...
    const mainImages = document.getElementById("game_main_images");
    const listImages = document.getElementById("game_list_images");
    const editorImages = document.getElementById("game_editor_images");
